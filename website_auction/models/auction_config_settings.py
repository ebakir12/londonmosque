...
class WebsiteAuctionConfigSettings(models.Model):
	...
	#################### Auction Result  ############################
	default_publish_bidders_name=fields.Selection(selection=name_list,
	...
	default_publish_bid_record = fields.Integer(string='Publish Bid Recors',related="website_id.publish_bid_record",required=1, readonly=False)

	default_publish_winner_name=fields.Selection(selection=name_list,
	...
	default_publish_bid_unsubscribe_msz = fields.Text(string='An Un-Subscribed Message For Auction',
