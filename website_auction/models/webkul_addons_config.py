...
class WebkulWebsiteAddons(models.TransientModel):
    ...
    def get_auction_config_view(self):
        ...
        action = imd.xmlid_to_object('website_auction.action_website_auction_configuration')
        list_view_id = imd.xmlid_to_res_id('website_auction.view_website_auction_config_settings_tree')
        form_view_id = imd.xmlid_to_res_id('website_auction.view_website_auction_config_settings_form')
        result = {
            'name': action.name,
            'help': action.help,
            'type': action.type,
